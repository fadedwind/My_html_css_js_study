...
//    IE6 does not handle this properly:
//    aDiv.setAttribute("class", CSS_CLASS);
    aDiv.className = CSS_CLASS;
  }
  ...
  if (window.document.addEventListener) {
    ...
    window.document.onmousemove = updateDivs;
  }
  return;
}
...
function updateDivs(event) {
  ...
  // Convert IE event object to DOM Event instance if necessary
